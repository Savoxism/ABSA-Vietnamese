import regex as re # working with regular expressions
import string
import emoji

from vncorenlp import VnCoreNLP # tokenization, pos tagging, and ner
from nltk import flatten #hanlding nested tokenized ouput, where each sentence is a list of tokenized words
...
### STEP 5: REMOVE UNNECESSARY CHARACTERS
